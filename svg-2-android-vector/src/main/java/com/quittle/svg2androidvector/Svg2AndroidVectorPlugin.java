            ...
            for (Directory directory : setOfDirs) {
                ...
                if (resDir.exists()) {
                    ...
                    svgTree.forEach(svgFile -> {
                        ...
                        // Accoding to documentation
                        // https://developer.android.com/reference/tools/gradle-api/8.12/com/android/build/api/variant/SourceDirectories.Layered
                        // the collection variantRes is represented as a List where the first elements are the highest priority ones.
                        // So first founded svg file has the highest priority.
                        // Ignore next svg with the same filename in different flavours and in the main.
